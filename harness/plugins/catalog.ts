...
export const PUREGAMMA_CAPABILITIES: readonly PureGammaCapabilityDescriptor[] = [
  ...
  },
  {
    ...
    tools: ['research_code_run', 'research_code_status', 'research_code_cancel'],
  ...
  },
  {
    ...
    risk: 'stateful',
    services: ['pgSkills'],
    tools: ['skill_catalog', 'skill_run', 'skill_run_status'],
  ...
  },
  {
    ...
    risk: 'read-only',
    services: ['pgOptions'],
    tools: ['options_chain', 'options_long_gamma', 'options_surface', 'options_surface_tickers', 'options_earnings_gamma'],

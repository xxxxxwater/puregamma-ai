...
struct AccountView: View {
    ...
    private var privacy: some View { Section("Privacy & legal") { Link("Privacy policy", destination: AppLinks.privacyPolicy); Link("Terms of service", destination: AppLinks.terms); Link("Contact support", destination: AppLinks.support) } }

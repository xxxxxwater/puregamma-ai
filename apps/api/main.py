...
from apps.api.routers import admin, agent, apple_auth, assets, auth, backtest, backtest_lab, billing, captcha, custody, email_auth, frontend, gateway, google_auth, harness_runs, hyperliquid_stream, imessage_agent, internal, jev_trader, live_trading, market, memory, mobile, mobile_access, mobile_auth, news, notifications, opportunities, options, playbooks, portfolio, reports, research, research_runner, secretary, signals, skills, strategies, stripe_webhook, trading, wallet_auth
...
app.include_router(jev_trader.router)
...
# Mobile capabilities gate (contract v1): always registered, honest booleans.

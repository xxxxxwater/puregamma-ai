...
export default function SecretaryError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="border border-border-pg bg-bg-panel p-6">
      ...
      <button type="button" onClick={reset} className="mt-5 inline-flex items-center gap-2 border border-border-pg-strong px-3 py-2 text-sm hover:bg-bg-panel-muted">

        ...
        <div className="grid gap-10 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href={withLocale(locale, "/signup")} className="inline-flex items-center gap-2 border border-border-pg-strong bg-pg-white px-4 py-3 text-sm font-semibold text-pg-black">

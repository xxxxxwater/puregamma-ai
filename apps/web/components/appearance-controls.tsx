...
export function AppearanceControls({ locale }: { locale: "en" | "zh" }) {
  ...
  const buttonClass = "grid h-8 w-8 place-items-center border border-border-pg hover:border-border-pg-strong disabled:opacity-35";

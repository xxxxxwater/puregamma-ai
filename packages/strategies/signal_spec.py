...
DEFAULT_SIGNAL_SPECS: dict[str, SignalSpec] = {
    "BTC momentum breakout": SignalSpec(
        ...
        disclaimers=["Research signal only.", "This is not financial advice.", "No live trading is enabled."],
    ...
    "ETH/BTC rotation": SignalSpec(
        ...
        disclaimers=["Relative rotation research only.", "This is not financial advice."],
        readiness=READINESS_MVP_READY,
        backtest_quality="insufficient",
    ),

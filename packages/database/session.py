...
POST_BASELINE_COLUMNS = {
    ...
    ("backtest_runs", "engine"),
    ("backtest_runs", "strategy_id"),
    ("backtest_runs", "strategy_version"),
    ("backtest_runs", "spec_json"),
    ("backtest_runs", "data_snapshot_json"),
    ("backtest_runs", "assumptions_json"),
    ("backtest_runs", "error_json"),
    ("backtest_runs", "credits_reserved"),

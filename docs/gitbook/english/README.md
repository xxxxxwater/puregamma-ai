...
| --- | --- |
| [Getting Started](getting-started.md) | Sign up, sign in, tour, language & theme |
| [Feature Guide](features.md) | Dashboard, Agent, Secretary voice, briefs, options, backtesting, portfolio, notifications |
| [Billing & Credits](billing-credits.md) | Plans, metering, refunds |
| [FAQ & Roadmap](faq-roadmap.md) | Troubleshooting and future design |

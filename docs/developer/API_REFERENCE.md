...
| Method | Path | Auth required | Request body | Response example | Errors | Entitlement | Credit cost |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `POST` | `/signals/scan` | Yes | None | `{"signals":[{"asset":"BTC","direction":"long_watch","disclaimer":""}]}` | `401`, `402` insufficient credits | Current implementation does not block by plan | 8 |
